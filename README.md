...
```
wget -N https://raw.githubusercontents.com/cc18188/XrayR-script/master/install.sh && bash install.sh
```
...
[![Stargazers over time](https://starchart.cc/cc18188/XrayR.svg)](https://starchart.cc/cc18188/XrayR)
